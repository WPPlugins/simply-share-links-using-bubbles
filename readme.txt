...
Contributors: damses
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=D6DWCXA3ZCKNU
tags: images, link, share, bubble, wordpress, woocommerce, share links, share this, bubble, woocommerce products, products, funny, animated, screen, share image, floated share button, floated share link, floated share image, floating share button, floating share link, visibility, campaing, products campaing, related content, edit, seo, external link, page, redirect
Requires at least: 3.5
Tested up to: 3.5
Stable tag: 1.2
License: GPLv2 or later
License URI: http://www.gnu.org/licenses/gpl-2.0.html
This plugin allow you to show efective information to your users
...
<a href="http://plugins-damses.com" >The free version includes</a> version includes:
<ol>
<li>Choosing an image to display on the bubble</li>
<li>Election of a title</li>
<li>Choosing a short description</li>
<li>Choosing a URL for redirection</li>
<li>Election to open the URL in a tab or the current tab</li>
<li>Choice of colors bubble to fit over the design of your website</li>
<li>Choose only urls where the bubble will be displayed</li>
<li>Selecting the type of classic bubble or custom (your own image as a bubble)</li>
</ol>

<a href="http://plugins-damses.com/tutorial/?wordpress">Tutorial online</a>

If you need support please contact <a href="http://plugins-damses.com/#contact" >here</a>

Do you need a nice bubble for your site? <a href="http://plugins-damses.com/#contact" >Contact</a>
...
== Screenshots == 
1. Bubble in the home page
2. Happy halloween bubble, your imagination it is the bound
3. Hallloween image
